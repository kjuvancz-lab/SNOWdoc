...
locale: en-US
canonical_url: https://www.servicenow.com/docs/r/zurich/servicenow-platform/common-service-data-model-csdm/csdm-datafdn-dash-run-tab.html
release: zurich
...
In this example, a report on the **Run** tab indicates that several business service offerings don't have the required relationships to service instances. With this knowledge, Service owners can add the relationships to help ensure that customer service agents get complete information on the upstream impacts of applications that are down.
